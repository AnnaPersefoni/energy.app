...
app = Flask(__name__)
modelNo = pickle.load(open("modelNo.pkl", "rb"))

modelYes = pickle.load(open("model.pkl", "rb")) # THIS  
# modelYes = pickle.load(open("modelYes.pkl", "rb")) # Βγαζει πολλες μηδενικες τιμες
# modelYes = pickle.load(open("modelYesPoly.pkl", "rb"))

polyModelNo = pickle.load(open("polyModelNo.pkl", "rb")) # polynomial regression model
